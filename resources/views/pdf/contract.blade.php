...
<body>
    <div class="container">
        <table border="1">
            ...
            <tr class="md-size">
                <td class="pd-sm" colspan="2">
                    <b>Código: </b>
                    <label> PBA-PA-CYS-PRO-FOR-09 </label> / 
                    <b>Fecha Emisión</b>
                    <span> Mayo 2019 </span>
                </td>
                <td class="pd-sm">
        ...
        <p class="super-small-size justify mt-md">
            Entre quienes suscriben este documento, por una parte {!! $person->fullname !!}
            quien se identifica con la cédula de ciudadanía número  {!! $person->document !!}
            expedida en {!! $person->expedition_city !!}
