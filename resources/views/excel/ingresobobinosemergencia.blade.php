<table border="1">
    <tr>
        ...
        <td colspan="6" class="center">
            <strong>INGRESO BOVINOS POR  EMERGENCIA</strong><br>
    ...
    <tr>
        <td colspan="3"><strong>CODIGO: PBA-PM-PB-BOV-FOR-11</strong></td>
    ...
    <tr>
        ...
        <td colspan="8">{{ $data['veterinary'] }}</td>
    </tr>
    <tr>
        <td colspan="2"><strong>PROPIETARIO DEL ANIMAL:</strong></td>
        <td colspan="9">{{ $data['owner'] }}</td>
    </tr>
    <tr>
